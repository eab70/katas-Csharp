...
//However, fractions not simplified.
...
//Tips
//Make sure to isolate the denominator first and find a multiple that goes into each of the 
//denominators. You can start by finding the least common multiple (the smallest integer value 
//that fits into both denominators). The greatest common denominator is the largest integer value 
//which fits into both denominators.

//Added Difficulty
//Try working on more than two terms.
